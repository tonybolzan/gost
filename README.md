This dockerfile builds an image of [gost-2.4-dev20170303](https://github.com/ginuerzh/gost/releases) based on [debian:oldstable-slim](https://hub.docker.com/_/debian/)
***
#### Quick Start
